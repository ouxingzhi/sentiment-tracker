...
class RSSCollector(BaseCollector):
    ...
    RSS_FEEDS = [
        ...
        "http://www.ce.cn/rss/finance.xml",  # 中国经济网
...
class WeiboCollector(BaseCollector):
    ...
    def __init__(self, weibo_cookie: str = None):
        super().__init__()
        self.weibo_cookie = weibo_cookie or getattr(settings, 'weibo_cookie', '')
